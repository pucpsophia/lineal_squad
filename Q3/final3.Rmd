...
causar que los valores estimados de Fertilidad salgan 66 cuando las variables independientes son 0.
...
vif(lm1) #factor inflacionario de varianza
...
para este caso se está utilizando la variable Education
```
